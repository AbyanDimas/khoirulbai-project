...
export const Gallery = () => {
  ...
  if (loading) {
    return (
      <section className="container mx-auto px-4 py-12 md:py-16 bg-white dark:bg-gray-800">
    ...
    return (
      <section className="container mx-auto px-4 py-12 md:py-16 bg-white dark:bg-gray-800">
        <div className="text-center">
          ...
          <h3 className="text-lg md:text-xl font-medium dark:text-white">Error loading gallery</h3>
          <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm md:text-base">{error}</p>
          <button 
            onClick={() => window.location.reload()}
            className="mt-4 px-4 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors text-sm md:text-base"
          >
            Try Again
          </button>
        </div>
