        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-center text-gray-600 dark:text-gray-300 mb-4">
              Scan QRIS di atas menggunakan aplikasi mobile banking atau e-wallet Anda atau <strong>Transfer Bank Rekening <strong className='text-emerald-300'>BSI 7998006664</strong></strong> a.n. PANITIA REHAB MASJID KHOIRUL BAI
            </p>
